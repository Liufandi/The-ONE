...
public class DTNHost implements Comparable<DTNHost> {
	...
	private double simEndTime=SimScenario.ENDTIME;
	...
	/**
	 * 
	 * @param  add an array for times of hosts contact
	 */
	
	double simtime=this.simEndTime;
	
	int v1=(int)simtime/86400;
	
	/**
	 * 休眠统计数组建立，二维数组，第一维代表实验天数，第二维代表一天中每半小时的划分
	 * 
	 */
	
	public int PerThrityMinuteContact[][]=new int[v1][48];
	public float dutycycle=0.2f;
...
//		float printTime=Float.parseFloat(df.format(SimClock.getTime()));
...
//	public void sleep(double sleepDelay,double sleepFor){
//		sleepTime=SimClock.getTime()+sleepDelay;
//		wakeTime=SimClock.getTime()+sleepFor+sleepDelay;
//		
//	}
	
//	public void updateSleepFlag(){
//		if(SimClock.getTime()>=sleepTime&&SimClock.getTime()<=wakeTime)
//			sleep=true;
//		if(sleep){
...
//	}
	public void sleep(){				
		sleep=true;
		float sleeptime=5-5*this.dutycycle;
		wakeTime=SimClock.getTime()+sleeptime;
